...
- [ ] **Level Selector:** Add a "Settings" or "Menu" toggle to switch between Kindergarten (Letters/CVC) and 1st Grade (Sight Words).
- [ ] **Win State:** Define what happens after X words (e.g., a "Level Complete" screen with fireworks).
- [ ] **Visual Polish:** Add a "Main Character" (SVG Mascot) that reacts to typing.

## 🔮 Phase 3: Persistence & PWA
- [ ] **Local Storage:** Save the user's high score and selected difficulty level so it remembers them on refresh.
